...
class K {
  ...
  // Judgment windows (± ms around the target time). Tuned generous for a mobile
  // casual feel — tight enough that PERFECT is earned, forgiving enough that
  // honest taps don't read as misses (a common "feels unfair" complaint).
  static const int wPerfect = 45;
  static const int wGreat = 90;
  static const int wGood = 135;

  // HP / life — slightly forgiving so one slip doesn't snowball into a fail.
